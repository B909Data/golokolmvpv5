        ...
        <section className="px-4 pb-8 pt-2">
          <div className="max-w-4xl mx-auto">
            <div className="bg-primary rounded-xl p-6 space-y-4">
              ...
              {/* Artist Door Button with Tooltip */}
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    onClick={() => navigate(`/after-party/${eventId}/room?artist_token=${token}`)}
                    variant="outline"
                    className="w-full border-primary-foreground/30 text-primary-foreground hover:bg-primary-foreground hover:text-primary font-sans text-base py-6"
                  >
                ...
                <TooltipContent>
                  <p>Enter the After Party as the artist.</p>
                </TooltipContent>
              </Tooltip>
            </div>
          </div>
