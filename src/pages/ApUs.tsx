    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="pt-16">
        <div className="relative w-full">
          <img src={heroImage} alt="Artists on stage" className="w-full h-auto block" />
      ...
      <section>
        <div className="relative w-full">
          <img src={section2Image} alt="Stage setup" className="w-full h-auto block" />
          <div className="absolute inset-0 bg-background/40" />
          <div className="absolute inset-0 flex flex-col justify-center items-start px-6 md:px-12 lg:px-20 pt-5">
            <div className="max-w-3xl">
      ...
      <section>
        <div className="w-full">
          <img src={section3Image} alt="Artists connecting" className="w-full h-auto block" />
        </div>
        <div className="bg-background px-6 md:px-12 lg:px-20 py-10 md:py-14">
          <div className="max-w-4xl">
