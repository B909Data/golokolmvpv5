...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirm your email for GoLokol',
  invite: "You've been invited to GoLokol",
  magiclink: 'Special link to submit your music',
  recovery: 'Reset your GoLokol password',
  email_change: 'Confirm your email change for GoLokol',
...
const SENDER_DOMAIN = "notify.golokol.app"
const ROOT_DOMAIN = "golokol.app"
const FROM_DOMAIN = "notify.golokol.app" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://golokolmvpv5.lovable.app"
