...
import heroImage from "@/assets/connect-card.jpg";
...
const HowItWorksCard = ({
  ...
  <Link
    to={to}
    className="group block rounded-2xl border border-[#E8E8E8] bg-white overflow-hidden transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
  >
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-start overflow-hidden">
        ...
        <div className="relative z-10 px-6 md:px-12 lg:px-20 pt-32 pb-16 max-w-3xl">
          ...
          <p className="text-white text-base mt-4 max-w-xl opacity-90">
      ...
      {/* WHY LOCAL */}
      <section className="bg-gradient-to-br from-[#FFD600] to-[#FFC300] px-6 md:px-12 lg:px-20 py-16 md:py-24">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            ...
            <p className="text-lg text-black leading-[1.8] mb-6">
